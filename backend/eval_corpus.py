...
CORPUS: List[Dict[str, Any]] = [
    ...
    {
        "name": "hms_smoke_without_firms",
        "location": {"lat": 45.304, "lon": -121.754, "name": "Government Camp", "zip_code": "97028", "state": "OR", "city": "Government Camp"},
        ...
        "signals": [
            ...
            {"id": "wfigs_incident", "status": "present", "count": 1, "alignment": "upwind",
             "incident": {"name": "Grasshopper Fire", "size_acres": 35000, "percent_contained": 19,
                          "state": "OR", "distance_miles": 22.0, "bearing": "E", "is_upwind": True}},
    ...
    {
        "name": "wfigs_incident_only",
        "location": {"lat": 44.05, "lon": -121.3, "name": "Bend", "zip_code": "97701", "state": "OR", "city": "Bend"},
        "observation": {"aqi": 110, "primary_pollutant": "PM2.5", "category": "Unhealthy for Sensitive Groups"},
        "signals": [
            ...
            {"id": "wfigs_incident", "status": "present", "count": 1, "alignment": "upwind",
             "incident": {"name": "Grasshopper Fire", "size_acres": 35000, "percent_contained": 19,
                          "state": "OR", "distance_miles": 22.0, "bearing": "E", "is_upwind": True}},
            {"id": "wind", "status": "present", "speed_mph": 8.0, "direction_deg": 90.0, "boundary_layer_height_m": 700.0},
            {"id": "surface_pm_level", "status": "present", "primary": True, "pm10_primary": False, "pm25_primary": True, "elevated": True},
            {"id": "ozone_heat", "status": "absent", "primary": False, "hot_day": False, "temperature_f": 70.0},
        ],
    },
    {
        "name": "rural_unexplained_pm",
        "location": {"lat": 46.15, "lon": -117.1, "name": "Clarkston", "zip_code": "99403", "state": "WA", "city": "Clarkston"},
